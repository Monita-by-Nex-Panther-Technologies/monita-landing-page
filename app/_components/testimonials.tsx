...
const testimonials: Testimonial[] = [
	{
		id: 1,
		quote: "Monita has made my business transactions seamless! I can now pay vendors and receive payments instantly without any hassle.",
		name: "Adekunle Olatunji",
		position: "Small Business Owner",
		avatar: Avatar,
	},
	{
		id: 2,
		quote: "As a freelancer, Monita helps me manage my finances easily. The fast transfers and bill payment options save me so much time!",
		name: "Chiamaka Eze",
	...
	{
		id: 3,
		quote: "With Monita, I no longer worry about late bill payments. I can pay for electricity, water, and even my internet subscription in seconds!",
		name: "Ibrahim Musa",
	...
	{
		id: 4,
		quote: "Monita is a game changer for me. Sending money to family and handling my daily expenses has never been this convenient!",
		name: "Folake Ajayi",
