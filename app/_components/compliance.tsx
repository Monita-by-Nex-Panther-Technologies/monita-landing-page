		...
		<section className="padding py-12 md:px-12 lg:px-20 xl:px-[10%] 2xl:px-[15%] overflow-hidden compliance grid gap-16 md:flex md:items-center">
				<div className="relative w-4/5 mx-auto md:w-1/3">
					...
					<motion.div
						...
						className="inset-y-2 inset-x-4 md:inset-x-2.5 w-[90%] size-full absolute"
					>
						<Image
							src={Rotate}
							alt=""
				...
				<div className="space-y-4 md:w-4/6">
					...
					<h2 className="header text-[2rem] leading-[2rem] md:text-4xl lg:text-6xl md:leading-tight">
						Ensuring Compliance and Building Trust with Monita
					</h2>

					<p className="text-sm md:text-base">
						At Monita, your safety is our priority. We comply with
						key regulations like NDPC and PCI DSS, partner with
						trusted, insured banks, and display our certifications
						to ensure secure, reliable, and transparent financial
